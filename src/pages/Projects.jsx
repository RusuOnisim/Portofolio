...
function Projects() {
  const technologies1 = ["Html", "Css", "Typescript"];
  const technologies2 = ["React", "Tailwind", "Typescript"];
  const technologies3 = ["React", "Tailwind", "Typescript"];
  ...
  return (
    ...
    >
      ...
      <motion.section className="flex-1 relative"
         ...
         animate="visible"
      >
          <img src={Cinemania} className="object-cover" alt="" />
        ...
        initial="hidden"
        animate="visible">
          <img src={Hangman} className="object-cover z-10" alt="" />
        ...
        initial="hidden"
        animate="visible">
          <img src={Quizz} className="object-cover z-10" alt="" />
        ...
        initial="hidden"
        animate="visible">
          <img src={Cookie} className="object-cover" alt="" />
