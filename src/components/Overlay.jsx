...
function Overlay({ technologies, liveLink }) {
  ...
  return (
    <div className={` ${isDarkMode ? "bg-colordarklogo" : "bg-colorbrightlogo"} rounded-xl absolute flex lg:items-center pt-5 lg:pt-0 justify-center w-full h-full inset-0 opacity-0 transition-opacity  duration-1000 hover:opacity-90`}>
